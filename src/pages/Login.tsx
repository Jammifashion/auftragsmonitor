    ...
    <div className="h-screen w-screen flex items-center justify-center bg-slate-950">
      <div className="w-[400px] bento-card border-none shadow-2xl space-y-8">
        <div className="text-center space-y-4">
          <div className="mx-auto w-16 h-16 bg-emerald-500 rounded-2xl flex items-center justify-center text-slate-950 font-bold text-3xl shadow-lg shadow-emerald-500/20">
            A
          </div>
          <div>
            <h2 className="text-2xl font-bold text-white tracking-tight">Willkommen zurück</h2>
